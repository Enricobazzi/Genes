...
for i in ${CATcoords[@]}
  do
  bedtools getfasta -fo "${i}".fa -fi $GFF_Path/Felis_catus.Felis_catus_8.0.dna_sm.toplevel.fa -bed ${i}
done
...
for GENE in ${BLASTGENES[@]}
  ...
  blastn -query $GFF_Path/CatResults/${GENE} -db $BDB/lp23_plus_mt.fa -outfmt "6 qseqid sseqid sstart send length qcovhsp evalue" -out ${GENE/.gff3.fa/}.BLASTresults
