...
# modify .bed to allow .vcf compatibility (scaffold name matching) - insert a . at 4th character in each line
awk -vFS="" -vOFS="" '{$4=$4"."}1' Candidate.bed > Candidate.compatible.bed
...
bedtools intersect -wb -header -a lp_species_SNPs_tagged_filtered.vcf.gz -b Candidate.compatible.bed > $GFF_Path/VCF/lp_bedIntersect.vcf

```

#5c Clear duplicates from Intersect results
