...
# grab all empty results and print names in file cutting the 'cat_' part
wc -l *.gff3 | grep ' 0 ' | cut -d ' ' -f9 | sed 's/cat_//g' > HumanSearch.txt
...
for i in ${HUMANGENES[@]}
  do
  grep "${i/.gff3/}" Homo_sapiens.GRCh38.92.gff3 > human_${i/.gff3/}.gff3
